#+TITLE: Library as a Gem -  libzmq
#+LATEX: \pagebreak

* Overview

  ~laag-libzmq~ packages [[https://github.com/zeromq/libzmq][libzmq]] as a Ruby Gem, using [[https://github.com/colstrom/laag][laag]].
...
* Updating this Package
  ...
  #+BEGIN_SRC shell
    git-vendor update libzmq v4.2.3
  #+END_SRC
